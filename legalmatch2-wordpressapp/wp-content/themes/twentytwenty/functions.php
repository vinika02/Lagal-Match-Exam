...
function twentytwenty_sidebar_registration() {
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Footer column #1', 'twentytwenty' ),
				'id'          => 'sidebar-1',
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Footer column #2', 'twentytwenty' ),
				'id'          => 'sidebar-2',
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Footer column # 3', 'twentytwenty' ),
				'id'          => 'sidebar-3',
				'description' => __( 'Widgets in this area will be displayed in the second column in the footer.', 'twentytwenty' ),
			)
		)
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Find a Lawyer for your Legal Issue', 'twentytwenty' ),
				'id'          => 'find-1',
				'description' => __( 'Widgets in this area will be displayed in the second column in the footer.', 'twentytwenty' ),
			)
		)
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Search Column', 'twentytwenty' ),
				'id'          => 'find-2',
				'description' => __( 'Widgets in this area will be displayed in the second column in the footer.', 'twentytwenty' ),
			)
		)
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Ratings Reviews', 'twentytwenty' ),
				'id'          => 'find-3',
				'description' => __( 'Widgets in this area will be displayed in the second column in the footer.', 'twentytwenty' ),
			)
		)
